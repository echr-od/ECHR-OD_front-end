...
router.get('/:itemid/docs', async function(req, res, next) {
  try {
    ...
    const response = await api.get(`/cases/${itemid}/docs`);
    const data = response.data;
...
router.get('/:itemid/docs/:doctype', async function(req, res, next) {
  try {
    ...
    const response = await api.get(`/cases/${itemid}/docs/${doctype}`);
    const data = response.data;
...
//   try {
//     const itemid = req.params.itemid;
//     const response = await api.get(`/cases/${itemid}/entities`);
//     const data = response.data;
...
router.get('/:itemid', async function(req, res, next) {
  try {
    const itemid = req.params.itemid;
    const response = await api.get(`/cases/${itemid}`);
    const data = response.data;
...
router.get('/:itemid/citedapps', async function(req, res, next) {
  try {
    const itemid = req.params.itemid;
    const response = await api.get(`/cases/${itemid}/citedapps`);
    const data = response.data;
